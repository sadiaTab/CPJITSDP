...
public class OOB extends OzaBag {
	...
	//this array stores the non defective instances that are used to be compared to each defective instance during the training
    ...
    public void trainOnInstanceImpl(Instance inst) {
		...
		//System.out.println(classSize[0]+", "+classSize[1]);
		//System.out.println(theta.getValue()+" "+this.ensemble.length);
	...
	protected void updateClassSize(Instance inst) {
		if (this.classSize == null) {
			...
			// <---ge31/01/18 modification to start class size in different rates
//			System.out.println("modified: ggc");
//			classSize[0] = 0.9;
//			classSize[1] = 0.1;
		}
